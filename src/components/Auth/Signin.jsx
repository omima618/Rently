...
const Signin = () => {
    ...
    return (
        <div className="container mx-auto py-5">
            <h2 className="text-4xl mb-6 font-bold">Sign In</h2>
            <div className="flex justify-center items-center gap-5">
                <form
                    className="w-full md:w-1/2 shadow-xl shadow-gray-300 p-5 md-h:full rounded-3xl"
                ...
                >
                    ...
                    <div className="text-sm font-medium w-fit mx-auto md:mx-0 text-gray-400 dark:text-gray-300 hover:underline hover:text-cyan-600 mb-5">
                        <Link to="/forget-password">Forgot password ?</Link>
                    </div>
                    {/* R O U T E    T O    S I G N   UP */}
                    <div className="text-sm mx-auto w-fit md:mx-0 font-medium text-gray-900 dark:text-gray-300 mb-5">
                        Don't have account ?
                        <Link
                            to="/signup"
